...
Given Eu executo o script de reset pedido_kit_remove_sem_estoque_53.sql
...
Scenario: Efetua o cancelamento do pedido com kit
Meta:
@tag component:Regressão - RELOH
@context PEDIDOS
@base RELOH
...
!-- Then Eu salvo o pedido do teste @rgs-53 no relatorio
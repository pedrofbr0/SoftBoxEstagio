...
Scenario: Emite Nota Fiscal Avulsa Tipo 194 OUTRAS SAIDAS REM.PARA MANUTENCAO (ATIVO IMOBILIZADO)
Meta:
...
And Eu seleciono o tipo de nota fiscal 194
...
And Eu clico no botao Concluir emissao nf avulsa tipo 194
Then Eu salvo a nota fiscal do teste @nf-31 no relatorio
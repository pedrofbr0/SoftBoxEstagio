...
Scenario: Emite Nota Fiscal Avulsa Tipo 465 NOTA COMPLEMENTAR ICMS DEV COMPRA
Meta:
...
And Eu seleciono o tipo de nota fiscal 465
...
And Eu clico no botao Concluir emissao nf avulsa tipo 465
Then Eu salvo a nota fiscal do teste @nf-46 no relatorio
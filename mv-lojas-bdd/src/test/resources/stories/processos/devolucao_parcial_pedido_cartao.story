...
!-- CRIAR FUNCAO PARA ALTERAR A DATA DE FECHAMENTO DO PEDIDO PARA ONTEM
And Alterar data do fechamento do pedido para regra de devolucao parcial
...
And Eu seleciono a Etapa ETAPA APROVACAO NAEC - JURIDICO pendente aprovacao
And Eu informo uma observacao para a Etapa ETAPA APROVACAO NAEC - JURIDICO

And Eu seleciono a Etapa LIBERA RECIBO SEM CONFIRMAÇÃO DE NF pendente aprovacao
And Eu informo uma observacao para a Etapa LIBERA RECIBO SEM CONFIRMAÇÃO DE NF

And Eu seleciono a Etapa ALERTA DE RECIBO NO PDV pendente aprovacao
And Eu informo uma observacao para a Etapa ALERTA DE RECIBO NO PDV

And Eu seleciono a Etapa GERAÇÃO DE REC.DEV S/CONFIRMACAO NF pendente aprovacao
And Eu informo uma observacao para a Etapa GERAÇÃO DE REC.DEV S/CONFIRMACAO NF

And Eu clico no botao Aprovar produto

!-- Fazer outro cenário de aprovação de produtos utilizando o botao Fluxo Aprovação ADM

!-- Aprovando Planilhas
And Eu clico no botao Planilhas do pre recibo
And Eu seleciono a forma de pagamento da devolucao 1 - Dinheiro
And Eu informo o valor da devolucao
And Eu clico no botao Aprovar planilha

...
public class RelatorioComissaoPage extends PageObject {
	...
	@FindBy(css = "input[data-sf-key='nro_usuario']")
	private WebElement nroFuncionario;
	...
	public RelatorioComissaoPage setNroFuncionario(String nroFuncionario) {
		this.nroFuncionario.clear();
		this.nroFuncionario.sendKeys(nroFuncionario);
		return this;
	}
	...
	public RelatorioComissaoPage clickBtnGerarRelatorio() {
		this.btnGerarRelatorio.click();
		return this;
	}

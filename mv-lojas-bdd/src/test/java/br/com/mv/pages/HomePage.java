...
public class HomePage extends PageObject {
	...
	public void acessarMenu(String descMenu, Boolean abrirPopup) throws InterruptedException {
		
		String[] links = descMenu.split(">");
		
		Thread.sleep(10000);
		new ControleMenu(this.getDriver()).navegar(links, abrirPopup);
//		new ControleMenu(this.getDriver()).acessarMenus(links, abrirPopup);
	}

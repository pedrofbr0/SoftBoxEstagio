...
public class PreReciboTrocaDevolucaoSteps {
	...
	@When("Eu seleleciono troca com reversao")
	public void euSelecionoTrocaComReversao() throws InterruptedException {
		preRecibo.selecionarTrocaComReversao();
	}
	
	@When("Eu valido valor do pedido com reversao")
	public void euValidoValorPedidoComReversao() throws InterruptedException {
		preRecibo.validarValorPedidoComReversao();
	}
	
	@When("Eu valido valor do pedido sem reversao")
	public void euValidoValorPedidoSemReversao() throws InterruptedException {
		preRecibo.validarValorPedidoSemReversao();
	}
	
	@When("Eu seleciono troca sem reversao")
	public void euSelecionoTrocaSemReversao() throws InterruptedException {
		preRecibo.selecionarTrocaSemReversao();
	}
	...
	/**
	 * Clica em botao Planilhas
	 * 
	 * @throws InterruptedException
	 */
	@When("Eu clico no botao Planilhas do pre recibo")
	public void euClicoBotaoPlanilhasProduto() throws InterruptedException {
		janela.abrirPopupClick(preRecibo.getBtnPlanilhas());
	}
	
	/**
	 * Seleciona forma pagto
	 * 
	 * @throws InterruptedException
	 */
	@When("Eu seleciono a forma de pagamento da devolucao $formaPagto")
	public void euSelecionoFormaPagtoDevolucao(String formaPagto) throws InterruptedException {
		//janela.abrirPopupClick(preRecibo.getBtnPlanilhas());
		preRecibo.informarFormaPagtoDevolucao(formaPagto);
	}
	 ...
	 * @throws InterruptedException
	 */
	@When("Eu informo o valor da devolucao")
	public void euInformoValorDevolucao() throws InterruptedException {
		preRecibo.informarVlrPagtoDevolucao();
	}
	 ...
	 * @throws InterruptedException
	 */
	@When("Eu clico no botao Aprovar planilha")
	public void euClicoBotaoAprovarPlanilha() throws InterruptedException {
		preRecibo.clicarBtnAprovarPlanilhas();
	}
	...
	public void euSelecionoOperacaoNotaFiscal(String tipoOperacao) throws InterruptedException {
		janela.abrirPopupSelect(nfAvulsa.getOperacaoNF(), tipoOperacao);
	}
	 ...
	 * @throws InterruptedException
	 */
	@When("Eu aprovo as notas do pedido")
	public void euAprovoNotasPedido() throws InterruptedException {
		nfAvulsa.aprovarNotasPedido();
	}
	...
	/**
	 * Seleciona o nota fiscal por tipo
	 * 
	 * @throws InterruptedException
	 */
	@When("Eu seleciono o nota fiscal tipo $tipoNF")
	public void euSelecionoNotaFiscal(String tipoNF) throws InterruptedException {
		parametros.selecionarNFPorTipo(tipoNF);
	}
	...
	public void euClicoBotaoConcluirParametros() throws InterruptedException {
		janela.fecharJanelaVoltarUltimoModal(parametros.getBtnConcluir());
	}
	...
	public void euClicoBotaoConcluirEmissaoNFAvulsa(String tipoNFAvulsa) throws InterruptedException {
		nfAvulsa.concluirEmissaoNFAvulsa(tipoNFAvulsa);
	}
	
	@Then("Eu salvo a nota fiscal do teste $codTeste no relatorio")
	public void euSalvoANotaFiscalNoRelatorio(String codTeste) throws InterruptedException, IOException {
		//nfAvulsa.concluirEmissaoNFAvulsa(tipoNFAvulsa);
		nfAvulsa.salvarNotaFiscalRelatorio(codTeste);
	}
	
	@Then("Eu salvo o cupom fiscal do teste $codTeste no relatorio")
	public void euSalvoOCupomFiscalNoRelatorio(String codTeste) throws InterruptedException, IOException {
		//nfAvulsa.concluirEmissaoNFAvulsa(tipoNFAvulsa);
		nfAvulsa.salvarCupomFiscalRelatorio(codTeste);
	}
	 ...
	 * @throws InterruptedException
	 */
	/*@When("Eu recupero o nro da nota fiscal na tela de consulta e salvo a nota fiscal do teste $codTeste no relatorio")
	public void euRecuperoNotaFiscalTelaConsultaSalvoRelatorio(String codTeste) throws InterruptedException {
		nfAvulsa.salvarNotaFiscalRelatorio(codTeste);
	}*/
	...
	@When("Eu clico no botao ok do alert")
	public void euClicoBotaoOkAlert() throws InterruptedException {
		obsDevolucaoItem.clickBotaoOkAlert();
	}
	...
	@When("Na nota fiscal avulsa eu seleciono o item $codItem")
	public void naNotaFiscalAvulsaEuSelecionoItem(String codItem) {
		nfAvulsa.selecionarProdutoNotaFiscal(codItem);
	}
	
	@When("Na nota fiscal avulsa eu clico no botao Remover Produto")
	public void naNotaFiscalAvulsaEuClicoBotaoRemoverProduto() {
		nfAvulsa.clickBtnRemoverProduto();
	}
}
...
public class MenuSteps {
    ...
    public void euAcessoOMenu(String descMenu) throws InterruptedException {
		
		home.acessarMenu(descMenu, false);
    }
	 ...
	 * @throws InterruptedException 
	 */
	@When("Eu acesso popup via menu $descMenuPopup")
    public void euAcessoPopupViaMenu(String descMenuPopup) throws InterruptedException {
		
		home.acessarMenu(descMenuPopup, true);
    }

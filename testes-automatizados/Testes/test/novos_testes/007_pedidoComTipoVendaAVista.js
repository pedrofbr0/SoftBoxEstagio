...
var dadosPedido = require('../../data/007/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 007
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\n   PEDIDO COM TIPO DE VENDA A VISTA, GARANTIA MAIOR E TROCA GARANTIDA, SERVICOS SEGUROS BRADESCO CAMINHÃO E TROCA GARANTIDA, EMPENHO LOJA ENTREGA NORMAL', 0, function suite(test) {

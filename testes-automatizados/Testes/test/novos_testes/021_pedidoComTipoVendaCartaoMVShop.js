...
var dadosPedido = require('../../data/021/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 021
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\n PEDIDO COM TIPO DE VENDA CARTAO MVSHOP', 0, function suite(test) {

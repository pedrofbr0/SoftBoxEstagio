...
var dadosPedido = require('../../data/026/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 026
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\n PEDIDO COM TIPO DE VENDA DEPOSITO EM CONTA', 0, function suite(test) {
...
function execTest(data) {
    ...
    casper.then(function () {
        telaProduto.cancelarEmpenho(dadosPedido[data.banco].cancelar_produto);
    });

    casper.then(function () {
        telaProduto.reempenharProduto(dadosPedido[data.banco].reempenho, true);
    });
    ...
    casper.then(function () {
        telaProduto.cancelarEmpenho(dadosPedido[data.banco].reabertura2.cancelar_produto);
    });

    casper.then(function () {
        telaProduto.reempenharProduto(dadosPedido[data.banco].reabertura2.reempenho, true);
    });

...
var dadosPedido = require('../../data/017/pedido_venda_produto.json');
var dadosConexao = require('../../data/conexao.json');
var dadosCliente = require('../../data/017/cadastro_cliente.json');
...
/*
 * CASOS DE TESTE - Documentação test 017
 */
...
//
//    casper.then(function () {
//        cadCliente.cadatroCompletoCliente(dadosCliente[data.banco]);
//    });

...
var dadosPedido = require('../../data/033/pedido_venda_produto.json');
...
casper.test.begin('\n@TestCase:\n PEDIDO COM TIPO DE VENDA CARTAO CREDITO EMPENHO LOJA E ENTREGA NORMAL', 0, function suite(test) {
...
function execTest(data) {
    ...
    casper.then(function () {
        this.echo(".. Informando valor de entrada: " + dadosPedido[data.banco].desc_tipo_venda);
        mvLojas.$val("#txt-entrada", dadosPedido[data.banco].valor_entrada);
    });

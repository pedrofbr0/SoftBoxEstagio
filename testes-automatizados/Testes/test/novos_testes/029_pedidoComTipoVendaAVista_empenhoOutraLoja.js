...
var dadosPedido = require('../../data/029/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 028
 */
...
function execTest(data) {
	...
	casper.then(function() {
		mvLojas.autenticar(dadosPedido[data.banco].segundo_login_loja, "7380", "1", data.banco, 5)
	})
    ...
    casper.then(function () {
        telaProduto.cancelarEmpenho(dadosPedido[data.banco].reabertura1.cancelar_produto_2);
    });
    
    casper.then(function () {
       telaProduto.removerProduto(dadosPedido[data.banco].reabertura1.remover_produto);
    });

...
var dadosPedido = require('../../data/008/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 008
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\n PEDIDO COM TIPO DE VENDA A VISTA, GARANTIA INSTALACAO DE TV, SERVICOS CLARO - RECARGA CELULAR E INSTALACAO DE TV, EMPENHO OUTRA LOJA ENTREGA NORMAL', 0, function suite(test) {

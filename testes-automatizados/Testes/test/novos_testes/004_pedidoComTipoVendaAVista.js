...
var dadosPedido = require('../../data/004/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 004
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\n PEDIDO COM TIPO DE VENDA A VISTA, GARANTIA BANDA LARGA MODEM E SUPORTE TV, SERVICOS FRETE', 0, function suite(test) {

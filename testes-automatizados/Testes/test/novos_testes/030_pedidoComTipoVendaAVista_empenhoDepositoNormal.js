...
var dadosPedido = require('../../data/030/pedido_venda_produto.json');
...
casper.test.begin('\n@TestCase:\n PEDIDO COM TIPO DE VENDA A VISTA EMPENHO DEPOSITO E ENTREGA NORMAL', 0, function suite(test) {
...
function execTest(data) {
    ...
    casper.then(function () {
    	var nomArquivoPedido = casper.cli.get("nome_arquivo_pedido");

...
var dadosPedido = require('../../data/002/pedido_venda_produto_A.json');
...
/*
 * CASOS DE TESTE - Documentação test 002
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\nPEDIDO COM TIPO DE VENDA A VISTA, GARANTIA INSTALACAO DE TV E PERFUMARIA, SERVICOS SEGUROS BRADESCO CAMINHAO E TROCA GARANTIDA, EMPENHO DEPOSITO ENTREGA AGENDADA CLIENTE', 0, function suite(test) {

...
var dadosPedido1 = require('../../data/036/pedido_venda_produto.json');
...
casper.test.begin('\n@TestCase:\nPEDIDO COM TIPO DE VENDA A VISTA, PROMOCAO DE KIT E VENDA AVULSA', 0, function suite(test) {
...
function execTest(data) {
    ...
    casper.then(function () {
        dadosPedido1[data.banco].nro_pedido = mvLojas.getNumPedido();
    });
    ...
    if (data.receber_pedido) {
        ...
        casper.then(function () {
        	telaRecebimentoPedido.receberPedido(dadosPedido1[data.banco]);
        });
    }

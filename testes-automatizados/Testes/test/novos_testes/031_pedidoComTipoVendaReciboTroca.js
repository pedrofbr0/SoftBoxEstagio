...
var dadosPedido = require('../../data/031/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 031
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\n PEDIDO COM TIPO DE VENDA RECIBO DE TROCA', 0, function suite(test) {

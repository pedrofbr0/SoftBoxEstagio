...
var dadosPedido = require('../../data/003/pedido_venda_produto.json');
...
/*
 * CASOS DE TESTE - Documentação test 003
 */

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\nPEDIDO COM TIPO DE VENDA A VISTA, GARANTIA SOLUCAO CERTA INFORMATICA E SERVICOS DE MONTAGEM DE MOVEIS, SERVICOS CLARO - RECARGA CELULAR E INSTALACAO DE TV, EMPENHO DEPOSITO ENTREGA RETIRADA OUTRA LOJA COM EMPENHO DEPOSITO', 0, function suite(test) {

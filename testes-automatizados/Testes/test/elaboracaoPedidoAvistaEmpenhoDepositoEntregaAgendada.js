...
var dadosPedido = require('../data/pedido_avista_empenho_deposito_entrega_agendada.json');
...
var execTestEmpresas = {"MVSH": true, "RELODEV": true};

/*@estrutura da suite de teste*/
casper.test.begin('\n@TestCase:\nFluxo principal de elaboração de pedido com pagamento a vista, empenho depósito e entrega agendada.', 0, function suite(test) {

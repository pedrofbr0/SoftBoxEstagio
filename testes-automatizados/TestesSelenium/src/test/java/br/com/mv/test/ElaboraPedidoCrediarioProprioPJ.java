...
public class ElaboraPedidoCrediarioProprioPJ {
	...
	private static final String IP = "http://10.30.232.20:8080/"; 
	private static final String LOJA = "1145"; // 6005 1090
	private static final String USUARIO = "7380";
	private static final String SENHA = "1";
	
	private static final String CNPJ = "37138260000138"; //"69201317000192"; //34902788365
	...
	public void test() throws InterruptedException {
		...
		load.aguardarCarregamentoNovaArquitetura();
		cliente.clickTipoPessoa().setCNPJ(CNPJ).clickPesquisar();
		...
		// Consulta o retorno da proposta (O RETORNO NÃO É AUTOMÁTICO ENTÃO VALIDAMOS SOMENTE ATÉ O ENVIO)

...
import br.com.mv.dao.usuario.UsuarioDAO;
import br.com.mv.utils.AguardaCarregamento;
import br.com.mv.utils.ControleJanela;
import br.com.mv.utils.ControleMenu;

public class PopupCadastroSolicitacaoTD {
	...
	public PopupCadastroSolicitacaoTD(WebDriver driver) {
		this.driver = driver;
	...
	public PopupCadastroSolicitacaoTD setEmpresa(String empresa) {
		this.empresa.clear();
	...
	public PopupCadastroSolicitacaoTD setPedido(String pedido) {
		this.pedido.clear();
	...
	public PopupCadastroSolicitacaoTD setLoja(String loja) {
		this.loja.clear();
	...
	public PopupCadastroSolicitacaoTD setProcesso(String processo) {
		this.processo.clear();
	...
	public PopupCadastroSolicitacaoTD setNroPreRecibo(String nroPreRecibo) {
	...
	public PopupCadastroSolicitacaoTD setSituacaoPreRecibo(String situacaoPreRecibo) {
	...
	public PopupCadastroSolicitacaoTD setValorPreRecibo(String valorPreRecibo) {
	...
	public PopupCadastroSolicitacaoTD clickBtnSalvar() {
	...
	public PopupCadastroSolicitacaoTD clickBtnCancelar() {
	...
	public PopupCadastroSolicitacaoTD clickBtnMotivoProduto() {
	...
	public PopupCadastroSolicitacaoTD clickBtnMotivoServico() {
		this.btnMotivoServico.click();
		return this;
	}

	public PopupCadastroSolicitacaoTD selecionarProduto(String produto) {
		driver.findElement(By.xpath("//table[@id='tableProdutos:tContent']/tbody/tr/td[text()='" + produto + "']/parent::tr/td[2]")).click();
		return this;
	}
	
	public PopupCadastroSolicitacaoTD selecionarServico(String servico) {
		driver.findElement(By.xpath("//table[@id='tableServicos:tContent']/tbody/tr/td[text()='" + servico + "']/parent::tr/td[3]")).click();
		return this;
	}

 ...
 *
 */
public class NovoTrocaUmProdutoLojaReversao {
	...
	public void teste1() throws InterruptedException, SQLException, IOException {
		...
		elaboracaoPreRecibo.setFiltroBandeira(BANDEIRA).setFiltroPedido(Integer.toString(NRO_PEDIDO)).setFiltroLoja(Integer.toString(NRO_LOJA_PEDIDO)).setComboProcesso(TIPO_PROCESSO_DESC)
				.setReversaoCredito().clickPesquisar();
		...
		// Execução 04/08 aprovado automaticamente
		//aprovacaoTrocaDevolucao.clickAprovarReversao();

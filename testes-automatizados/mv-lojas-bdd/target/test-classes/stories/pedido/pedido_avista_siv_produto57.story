...
Eu quero elaborar um pedido a vista com kit, promoção e que tenha serviço vinculado obrigatorio (PLANO CONTROLE)
...
Given Eu executo o script de reset pedido_avista_siv_57.sql
...
And Eu seleciono a promocao de valor 0,89
...
And Eu valido a mensagem da regra I do SIV
And Eu clico no botao Ok do modal
...
!-- And Eu salvo o pedido do teste @rgs-57 no relatorio

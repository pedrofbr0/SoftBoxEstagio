...
Eu quero elaborar um pedido a vista com data de retenção
De modo que o pedido seja criado ao finalizar o processo

Scenario: Elaborar um pedido a vista com data de retenção
Meta:
...
And Eu salvo o pedido do teste @smk-05 no relatorio
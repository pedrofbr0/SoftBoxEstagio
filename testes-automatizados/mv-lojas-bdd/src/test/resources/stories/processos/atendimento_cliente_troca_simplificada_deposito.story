...
Scenario: Elaborar um pedido a vista com empenho em deposito/normal
Meta:
...
And No recibo de troca eu seleciono Data de Entrega
And No recibo de troca eu clico botao Ok Agendamento de Entrega
And Eu clico botao Ok no modal de agendamento de entrega
...
Scenario: Cria a carga para associar ao controle de faturamento TIPO R 
Meta:
@tag component:Processos - RELOH
@context PROCESSOS
@base RELOH

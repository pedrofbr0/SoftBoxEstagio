...
Scenario: Emite Nota Fiscal Avulsa Tipo 840 ESTORNO CREDITO DE ICMS
Meta:
...
And Eu seleciono o tipo de nota fiscal 840
...
And Eu clico no botao Concluir emissao nf avulsa tipo 840
Then Eu salvo a nota fiscal do teste @nf-54 no relatorio
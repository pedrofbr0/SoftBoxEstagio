...
Scenario: Emite Nota Fiscal Avulsa Tipo 233 COMPRA DE ATIVO IMOBILIZADO
Meta:
...
And Eu seleciono o tipo de nota fiscal 233
...
And Eu clico no botao Concluir emissao nf avulsa tipo 233
Then Eu salvo a nota fiscal do teste @nf-17 no relatorio
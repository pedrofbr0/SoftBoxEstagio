...
Scenario: Emite Nota Fiscal Avulsa Tipo 844 RESSARCIMENTO DE ICMS - ENTRADA
Meta:
...
And Eu seleciono o tipo de nota fiscal 844
...
And Eu clico no botao Concluir emissao nf avulsa tipo 844
Then Eu salvo a nota fiscal do teste @nf-25 no relatorio
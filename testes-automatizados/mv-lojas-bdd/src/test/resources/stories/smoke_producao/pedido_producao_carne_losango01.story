Narrative:
Como um usuário de suporte da loja
Eu quero realizar uma consulta simplificada para o tipo de venda 66 - Carne Losango e quero elaborar um pedido financiado com empenho em DEPOSITO/RETIRADA OUTRA LOJA COM RESERVA DEPOSITO, e duas formas de pagamento à vista e boleto
De modo que o pedido seja criado ao finalizar o processo e esteja com o status Ag. Liberação

Scenario: Elaborar um pedido financiado com empenho DEPOSITO/RETIRADA OUTRA LOJA COM RESERVA DEPOSITO
Meta:
@tag component:Smoke - Producao RELO
@context SMOKE_PEDIDO_PRODUCAO
@base RELO
@issue smk-prd-01
@smk-prd-01

Given Eu acesso a instancia http://10.41.0.31:8080
...
And Eu informo o tipo de venda 66 - CARNE LOSANGO SCRED
And Eu clico no botao 'Enviar'
And Eu aguardo a consulta pre-simplificada ser processada
And Eu clico em 'Consultar'

...
public class PedidoSteps {
	 ...
	 * @throws InterruptedException
	 */
	@When("Eu seleciono a data do primeiro vencimento")
	public void euSelecionoPrimeiroVencimento() throws InterruptedException {
		pedido.selecionarPrimeiroVencimento();
	}
	 ...
	 * @throws InterruptedException
	 */
	@When("Eu clico no icone detalhes de produto nao empenhado $codNroProduto")
	public void euClicoNoBotaoDetalhesDeProdutoNaoEmpenhado(String codNroProduto) throws InterruptedException {
		
		pedido.clicarIconeDetalhesProdutoNaoEmpenhado(codNroProduto);
	}
	 ...
	 * @throws InterruptedException 
	 */
	@Then("Eu clico no botao Sim do modal")
	...
	@Then("Eu valido a mensagem de obrigatoriedade de pelo menos 1 servico e 1 tipo de servico vinculados na promocao")
	public void euValidoMensagemObrigatoriedadePeloMenos1ServicoETipoServico() throws InterruptedException {
		
		pedido.validarMensagemObrigatoriedadePeloMenos1ServicoETipoServico();
	}
	
	@Then("Eu valido a mensagem da regra I do SIV")
	public void euValidoMensagemRegraISIV() throws InterruptedException {
		
		pedido.validarMensagemRegraISIV();
	}
	
	@Then("Eu valido a mensagem da regra II do SIV")
	public void euValidoMensagemRegraIISIV() throws InterruptedException {
		
		pedido.validarMensagemRegraIISIV();
	}
	
	@Then("Eu valido botao Ativar Plano Controle")
	public void euValidoBotaoAtivarPlanoControle() throws InterruptedException {
		
		pedido.botaoVisivelAtivarPlanoControle();
	}
	...
	public void euRemovoOServico(String nroServico) throws InterruptedException {
	...
	public void euClicoBotaoAgendada() throws InterruptedException {
	...
	@When("Eu informo o cpf $cpf para consulta de notas")
	public void euInformoCpfConsultaNotas(String cpf) throws InterruptedException {
		
		pedido.informarCpfConsultaNotas(cpf);
	}
	
	@When("Eu seleciono a nota relacionada ao pedido")
	public void euSelecionoNotaRelacionadaPedido() throws InterruptedException {
		
		pedido.selecionarNotaRelacionadaPedido();
	}
	 ...
	 * @throws InterruptedException 
	 */
	@When("Eu altero a quantidade do produto $codNroProduto para $quantidade")
	public void euAlteroAQuantidadeProduto(String codNroProduto, String quantidade) throws InterruptedException {
		
		pedido.alterarQuantidadeProduto(codNroProduto, quantidade);
	}
	...
	@When("Eu informo um pedido com credito")
	public void euInformoUmPedidoCredito() throws IOException {
		pedido.informarUmPedidoComCredito();
	}
	
	@When("Eu informo um codigo da loja do pedido com credito")
	public void euInformoUmCodigoLojaPedidoCredito() throws IOException {
		pedido.informarUmaLojaPedidoComCredito();
	}
	
	@When("Eu informo uma empresa do pedido com credito")
	public void euInformoUmaEmpresaPedidoCredito() throws IOException {
	...
	@Then("Eu clico no botao Sim realizar analise de credito")
	public void euClicoBotaoSimRealizarAnaliseCredito() throws IOException, InterruptedException {
		pedido.clicarBtnSimRealizarAnaliseCredito();
	}
	
	@Then("Eu clico no botao Nao realizar analise de credito")
	public void euClicoBotaoNaoRealizarAnaliseCredito() throws IOException, InterruptedException {
		pedido.clicarBtnNaoRealizarAnaliseCredito();
	}
	
	@Then("Eu clico no botao Comunicar")
	public void euClicoBotaoComunicar() throws InterruptedException {
		pedido.clicarBtnComunicar();
	}
	
	@Then("Eu marco o documento Identidade para comunicacao")
	public void euMarcoDoctoIdentidadeParaComunicao() throws InterruptedException {
		pedido.selecionarIdentidade();
	}
	
	@Then("Eu marco o documento CPF para comunicacao")
	public void euMarcoDoctoCPFParaComunicao() throws InterruptedException {
		pedido.selecionarCPF();
	}
	
	@Then("Eu marco o documento Comprovante Renda para comunicacao")
	public void euMarcoDoctoComprovanteRendaParaComunicao() throws InterruptedException {
		pedido.selecionarComprovanteRenda();
	}
	
	@Then("Eu informo observacao $observacao para comunicacao")
	public void euInformoObservacaoComunicacao(String observacao) throws InterruptedException {
		pedido.informarObservacaoComunicacao(observacao);
	}
	
	@Then("Eu clico no botao Enviar comunicacao")
	public void euClicoBotaoEnviarComunicacao() throws InterruptedException {
		pedido.clicarBotaoEnviar();
	}
	
	@Then("Eu clico no botao Ok proposta em processamento")
	public void euClicoBotaoOkPropostaProcessamento() throws InterruptedException {
		pedido.clicarBotaoOkPropostaProcessamento();
	}
	
	@Then("Eu acesso link de aprovacao de propostas")
	public void euAcessoLinkAprovacaoProposta() throws InterruptedException, IOException {
		pedido.acessarLinkAprovacaoPropostas();
	}
	
	@Then("Eu consulto a comunicacao")
	public void euClicoBotaoConsultarComunicacao() throws InterruptedException {
		pedido.consultarRetornoProposta();
	}
	
	@When("Eu clico no botao Captura de Limite")
	public void euClicoBotaoCapturaLimite() throws InterruptedException {
		pedido.verificarCapturaLimite();
	}
	
	@When("Eu clico no botao Analise de Credito")
	public void euClicoBotaoAnaliseCredito() throws InterruptedException {
		pedido.clicarBtnAnaliseCredito();
	}
	
	@When("Eu salvo na sessao o valor unitario do produto $codNroProduto")
	public void euSalvoValorUnitatioProdutoNaSessao(String codNroProduto) throws InterruptedException {
		pedido.salvarValorUnitarioProdutoSessao(codNroProduto);
	}
	
	@Then("Eu valido o valor unitario do produto $codNroProduto calculo reverso")
	public void euValidoValorUnitatioProdutoCalculoReverso(String codNroProduto) throws InterruptedException {
		pedido.validarValorUnitarioProdutoCalculoReverso(codNroProduto);
	}
	
	@When("Eu realizo a consulta pre simplificada")
	public void euRealizoConsultaPreSimplificada() throws InterruptedException {
		pedido.consultaPreSimplificada();
	}
	
	@When("Eu valido mensagem servico vinculado a combo")
	public void euValidoMensagemServicoVinculadoCombo() throws InterruptedException {
		pedido.validarMensagemServicoVinculadoCombo();
	}
	
	@When("Eu valido se o servico $nroServico nao existe no grid")
	public void euValidoServicoNaoExisteGrid(String nroServico) throws InterruptedException {
		pedido.validarServicoNaoExistenteGrid(nroServico);
	}

	@When("Eu verifico se o servico $nroServico nao existe no grid de consulta de servicos")
	public void euServicoNaoExisteNoGridConsultaServicos(String nroServico) throws InterruptedException {
		pedido.validarServicoNaoExistenteGridConsultaServicos(nroServico);
	}
	
	@When("Eu valido mensagem garantia vinculado a combo")
	public void euValidoMensagemGarantiaVinculadoCombo() throws InterruptedException {
		pedido.validarMensagemGarantiaVinculadoCombo();
	}
	
	@When("Eu valido se a garantia $nroServico nao existe no grid")
	public void euValidoGarantiaNaoExisteGrid(String nroServico) throws InterruptedException {
		pedido.validarGarantiaNaoExistenteGrid(nroServico);
	}
	
	@Then("Eu valido os valores do calculo reverso")
	public void euValidoValoresCalculoReverso() throws InterruptedException {
		pedido.validarValoresCalculoReverso();
	}
	
	@Then("Eu clico no botao Ativar Plano Controle")
	public void euClicoBotaoAtivarPlanoControle() throws InterruptedException {
		pedido.clicarBotaoAtivarPlanoControle();
	}
	
	@Then("Eu verifico se o botao Liberar pedido sem Ativacao nao esta presente")
	public void euVerificoBotaoLiberarPedidoSemAtivacaoNaoEstaPresente() throws InterruptedException {
		pedido.verificarBotaoLiberarPedidoSemAtivacaoNaoEstaPresente();
	}
	
	@Then("Eu clico no botao Liberar pedido sem Ativacao")
	public void euClicoBotaoLibearPedidoSemAtivacao() throws InterruptedException {
		pedido.clicarBotaoLiberarPedidoSemAtivacao();
	}	
	
	@Then("Eu verifico o status do pedido $status")
	public void euVerificoStatusPedido() throws InterruptedException {
		//pedido.clicarBotaoLiberarPedidoSemAtivacao();
	}
	
	@Then("Eu ativo o Plano Controle")
	public void euAtivoPlanoControle() throws InterruptedException {
		pedido.ativarPlanoControle();
	}
	
	@Then("Eu valido os valores do calculo reverso na planilha")
	public void euValidoValoresCalculoReversoPlanilha() throws InterruptedException, IOException {
		pedido.validarValoresCalculoReversoPlanilha();
	}
	
	@When("Alterar data do fechamento do pedido para regra de devolucao parcial")
	public void alterarDataFechamentoPedidoRegraDevolucaoParcial() {
		pedido.alterarDataFechamentoPedidoRegraDevolucaoParcial();
	}
	
	@Then("Eu clico no botao Liberar Aguardando Central")
	public void euClicoBotaoLiberarAguardandoCentral() {
		pedido.clicarBotaoLiberarAguardandoCentral();
	}
	
	@Then("Eu informo uma descricao $descricao para liberacao pos venda")
	public void euInformoDescricaoLiberacaoPosVenda(String descricao) {
		pedido.informarDescricaoLiberacaoPosVenda(descricao);
	}
	
	/*@Then("Eu clico no botao Sim do modal")
	public void euClicoBotaoSimModal() {
		pedido.clicarBotaoSimModal();
	}*/

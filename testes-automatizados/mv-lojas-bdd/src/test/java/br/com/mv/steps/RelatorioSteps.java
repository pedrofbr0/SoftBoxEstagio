...
public class RelatorioSteps {
	...
	@When("Eu informo o nro funcionario do relatorio de comissao analitico $nroFuncionario")
	public void euInformoNroFuncionarioRelatorioComissaoAnalitico(String nroFuncionario) throws InterruptedException {
		relatorioComissao.setNroFuncionario(nroFuncionario);
	}
	...
	@When("Eu clico no botao gerar relatorio de comissao analitico")
	public void euClicoBotaoGerarRelatorioComissaoAnalitico() throws InterruptedException {
		//janela.abrirPopupClick(relatorioComissao.getBtnImprimir(), true);
		relatorioComissao.clickBtnGerarRelatorio();
	}

...
public class PopupControleComissaoPage extends PageObject {
	...
	public PopupControleComissaoPage selecionarMes() throws InterruptedException {
		WebElement mes =  this.getDriver().findElement(By.xpath("//*[@id='table:tContent']/tbody/tr[1]/td[2]"));
		
		new ControleJanela(this.getDriver()).fecharJanelaVoltarUltimoModal(mes);
		return this;
	}

...
public class ControleJanela extends PageObject {
	...
	public void abrirPopupAlert(boolean accept) throws InterruptedException {
		...
		if (accept) {
			...
			//System.out.println("qtdJanelas alert" + qtdJanelas);
			//driver.switchTo().frame(qtdJanelas - 1).switchTo().alert().accept();
	...
	private void selecionarPopup() throws InterruptedException {
		...
		//System.out.println("janelasDepois");
		//System.out.println(janelasDepois);
		
		//janelasDepois.removeAll(janelasAntes);
		//this.popupAtivo = janelasDepois.iterator().next();
		
		//System.out.println("popupAtivo");
		//System.out.println(this.popupAtivo);
	...
	/**
	 * Volta para o janela principal aberto na tela
	 * @throws InterruptedException
	 */
